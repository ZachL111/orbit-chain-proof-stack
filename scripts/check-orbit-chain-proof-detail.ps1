...
$repo = "orbit-chain-proof-stack"
$language = "C"
$category = "Blockchain tooling"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/orbit-chain-proof-walkthrough.md")) {
...
if ($ship -ne 2) { throw "$repo ship lane count changed" }
