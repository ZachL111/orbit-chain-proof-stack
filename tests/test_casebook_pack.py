"""Regression checks for the orbit-chain-proof-stack casebook."""
...
from casebook.harness import assert_expected, orbit_chain_proof_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(orbit_chain_proof_stack_summary(), assert_expected())
